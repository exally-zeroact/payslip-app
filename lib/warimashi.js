...
(function (root, factory) {
  ...
  //  over60Add=60h超の増分(1.5−1.25=0.25)。RATE.over60(=1.5合成後)とは別の"増分"としてresolveRatesが参照。
  ...
  //  data 例: { ot:1.25, otNight:1.5, over60:1.5, over60Night:1.75, night:0.25, holiday:1.35, holidayNight:1.6, over60Add:0.25 }
  ...
  return {
    ...
    RATE: RATE, resolveRates: resolveRates, hydrate: hydrate, calc: calc, easyComponents: easyComponents, easy: easy,
