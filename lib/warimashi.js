...
(function (root, factory) {
  ...
  function detailComponents(seg, nightInc) {
    seg = seg || {}; var ni = (nightInc != null) ? num(nightInc) : RATE.night;
    var rateOf = { ot: 1.25, otNight: 1.25 + ni, over60: 1.5, over60Night: 1.5 + ni, night: ni, holiday: 1.35, holidayNight: 1.35 + ni };
  ...
  function detail(opts) {
    ...
    return calc(unit, detailComponents(opts.seg || {}, opts.nightRate));
  }
