...
(function (root, factory) {
  ...
  function calcBonusTax(o) {
    ...
    // 特例: 前月給与なし/社保以下、または賞与(社保後)が前月課税ベースの10倍超 → 月額表で計算(本表によらない・甲乙共通)
    if (prevAfter <= 0 || taxableBonus > prevAfter * 10) return { tax: 0, special: true, otsu: isOtsu, prevAfter: prevAfter };
