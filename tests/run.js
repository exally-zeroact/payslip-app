...
['./calc.test.js', './warimashi.test.js', './pref.test.js', './shaho-year.test.js', './shoyo-zei.test.js', './zaiseki.test.js', './shotokuzei-hei.test.js', './shotokuzei-densan.test.js', './zengin.test.js', './kintai-csv.test.js', './juminzei.test.js', './holidays.test.js', './saitei-chingin.test.js', './chingin-daicho.test.js', './xlsx.test.js', './payroll-calc.test.js', './leave-partial.test.js', './koyo-hoken.test.js', './nenmatsu.test.js', './pay-rule.test.js', './pay-parse.test.js'].forEach(function (f) {
  console.log('\n' + f);
  require(f);
});
