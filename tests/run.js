...
['./calc.test.js', './select.test.js', './warimashi.test.js', './pref.test.js', './shaho-year.test.js', './shoyo-zei.test.js', './zaiseki.test.js', './juminzei.test.js', './holidays.test.js', './xlsx.test.js', './payroll-calc.test.js'].forEach(function (f) {
  console.log('\n' + f);
  require(f);
});
